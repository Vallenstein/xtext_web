...
class LPDSLGenerator extends AbstractGenerator {
	...
	override void doGenerate(Resource resource, IFileSystemAccess2 fsa, IGeneratorContext context) {
		for (e : resource.allContents.toIterable.filter(PageHeader))
...
<head>
  <meta name="Generated Landing Page" content="This is a personal landing page generated by Web-Modeler" />
  <meta charset="utf-8">
  <title>«e.name.toString»</title>
