...
public class LPDSLGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    _builder.newLine();
    _builder.append("\t  ");
    _builder.append("scroll-behavior: smooth;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
  ...
  private void genFooter(final PageFooter footer) {
    ...
    _builder_2.newLine();
    _builder_2.append("  ");
    _builder_2.append("<div class=\"float-right\">");
    _builder_2.newLine();
    _builder_2.append("   ");
    _builder_2.append("<a type=\"button\" href=\"#\" class=\"btn btn-outline-secondary\">Take me upstairs!</a>");
    _builder_2.newLine();
    _builder_2.append("   ");
    _builder_2.append("</div>");
    _builder_2.newLine();
